<x-app-layout>
    ...
    <div class="container bg-white border-solid border-2 border-gray-300 rounded-sm shadow mx-auto flex flex-col my-24 py-4">
        ...
        <div class="px-7 flex flex-inline justify-center">
            <h2 class="text-4xl font-semibold">Edit Role</h2>
        </div>
                    ...
                    <table class="table-auto mx-auto bg-gray-100 w-2/3 rounded">
                        <tbody>
                            <tr>
                                ...
                                <td class="px-4 py-2">
                                    <input type="text" name="name" class="p-2 text-lg bg-transparent border-b border-gray-400 hover:bg-gray-200 focus:bg-gray-300 focus:border-green-500" placeholder="Name" value="{{ $role->name}}" focus required>
                                </td>
                            </tr>
                            <tr class="mb-32">
                                ...
                                <td class="px-4 py-2">
                                    <livewire:edit-role-permissions :roleId="$role->id"/>
                                </td>
                            </tr>
                        </tbody>
                    </table>
