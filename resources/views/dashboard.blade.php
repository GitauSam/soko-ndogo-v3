    ...
    <div x-data="{ sidebarOpen: false }" class="flex bg-gray-200">
        ...
        <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'" 
            ...
            <nav class="">
                ...
                <a class="flex items-center mt-32 py-2 px-6 bg-gray-700 bg-opacity-25 text-gray-100" href="#">
                ...
                @elseif (auth()->user()->can('product-list') && auth()->user()->can('order-list'))
        ...
        <!-- Sidepanel End -->
        <!-- Main Content Start  -->
        <div class="flex-1 flex flex-col overflow-hidden py-10">
