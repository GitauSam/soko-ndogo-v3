    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        <main class="flex-1 overflow-x-hidden overflow-y-auto py-10 bg-gray-100">
            <div class="container mx-auto px-6 py-8">
                <h3 class="text-gray-700 text-3xl font-medium mt-10">Dashboard</h3>
                <div class="mt-4">
                    <div class="flex flex-wrap -mx-6 py-4">
                        ...
                        <a href="{{ route('non-serviced-orders') }}" class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                            <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                    ...
                    <div class="flex flex-wrap -mx-6 py-2">
                        <!-- Start of statistics cards -->
                        <a href="{{ route('purchased-products') }}" class="w-full px-6 sm:w-1/2 xl:w-1/3">
                            <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                                <div class="p-3 rounded-full bg-indigo-600 bg-opacity-75">
                                    <svg class="h-8 w-8 text-white" viewBox="0 0 28 30" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="mx-5">
                                    @foreach($servicedProducts as $key => $value)
                                        <h4 class="text-2xl font-semibold text-gray-700">
                                            {{ $value }}
                                        </h4>
                                        <div class="text-gray-500">
                        ...
                        <a href="{{ route('serviced-orders') }}" class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                            <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                                <div class="p-3 rounded-full bg-orange-600 bg-opacity-75">
                                    <svg class="h-8 w-8 text-white" viewBox="0 0 28 28" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="mx-5">
                                    ...
                                    @foreach($servicedOrders as $key => $value)
                                        <h4 class="text-2xl font-semibold text-gray-700">
                                            {{ $value }}
                                        </h4>
                                        <div class="text-gray-500">
