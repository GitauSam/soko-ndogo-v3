<x-dashboard-app>
    <div class="w-full bg-gray-100">
        <div class="container mx-auto flex flex-col py-24 px-24">
                ...
                <form class="w-full px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 mx-auto mt-12" action="{{ route('products.update', \Illuminate\Support\Facades\Crypt::encryptString($product->id)) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-full md:w-1/2 lg:border-r-2 border-gray-300">
                            ...
                            <div class="px-3">
                                <input class="bg-gray-200 focus:bg-gray-100 block w-full text-gray-700 border-b-2 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-gray-500" id="grid-product-name" name="product_name" type="text" value="{{ $product->product_name }}">
                            </div>
                        </div>
                    ...
                    <div class="flex flex-wrap -mx-3">
                        <div class="w-full md:w-1/2">
                            <div class="w-full lg:border-r-2 border-gray-300">
                                ...
                                <div class="flex flex-col lg:flex-row gap-3 px-3">
                                    <input class="bg-gray-200 focus:bg-gray-100 block w-full text-gray-700 border-b-2 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-gray-500" id="grid-quantity" type="number" name="quantity" value="{{ $product->quantity }}">
                        ...
                        <div class="w-full md:w-1/2">
                            ...
                            <div class="flex flex-col lg:flex-row gap px-3">
                                <input class="bg-gray-200 focus:bg-gray-100 block w-full text-gray-700 border-b-2 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-gray-500" id="grid-quantity" type="number" name="price" value="{{ $product->price }}">
