            ...
            <form class="w-full px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 mx-auto mt-12" action="{{ route('orders.update', $order->id) }}" method="post">
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3 sm:mb-6 md:mb-0">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white" id="grid-order-name" name="order_name" type="text" value="{{ $order->order_name }}">
                    </div>
                </div>
